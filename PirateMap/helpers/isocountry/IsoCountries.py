...
class IsoCountry:
	...
	world_atlas_path = 'helpers/isocountry/input/worldatlas.html'
	data = {}
	...
	def parse_world_atlas(self):
		...
		for tr in root.xpath('/table/tr'):
			...
			self.data[two_lett] = {}
			self.data[three_lett] = {}
			self.data[two_lett]['full']=full
			self.data[two_lett]['lett']=three_lett
			self.data[three_lett]['lett']=two_lett
	...
	def convert_lett(self, lett):
		try:
			return self.data[lett]['lett']
		except KeyError:
			return False
